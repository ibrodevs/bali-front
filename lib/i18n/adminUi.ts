...
const EXACT_TRANSLATIONS: Record<string, TranslationPair> = {
  ...
  'Mark delivery': { ru: 'Отметить доставку', id: 'Tandai pengantaran' },
  'Mark active': { ru: 'Отметить как активную', id: 'Tandai aktif' },
  ...
  'Manage shared public paths and localized public titles for the main site pages and scooter detail pages.': { ru: 'Управляйте общими публичными путями и локализованными публичными названиями для основных страниц сайта и карточек скутеров.', id: 'Kelola path publik bersama dan judul publik terlokalisasi untuk halaman utama situs dan halaman detail skuter.' },
  ...
  'Main pages': { ru: 'Основные страницы', id: 'Halaman utama' },
  'Scooters': { ru: 'Скутеры', id: 'Skuter' },
  'Shared public path and localized browser tab titles for main site routes.': { ru: 'Общий публичный путь и локализованные заголовки вкладки браузера для основных маршрутов сайта.', id: 'Path publik bersama dan judul tab browser terlokalisasi untuk rute utama situs.' },
  'Shared route segment and localized public scooter titles for each language.': { ru: 'Общий сегмент маршрута и локализованные публичные названия скутера для каждого языка.', id: 'Segmen rute bersama dan judul publik skuter terlokalisasi untuk setiap bahasa.' },
  'Search scooters by title or slug': { ru: 'Ищите скутеры по названию или slug', id: 'Cari skuter berdasarkan judul atau slug' },
  'Loading scooter settings…': { ru: 'Загрузка настроек скутеров…', id: 'Memuat pengaturan skuter…' },
  'Choose a scooter to edit.': { ru: 'Выберите скутер для редактирования.', id: 'Pilih skuter untuk diedit.' },
  'Selected scooter': { ru: 'Выбранный скутер', id: 'Skuter terpilih' },
  'Current public URL:': { ru: 'Текущий публичный URL:', id: 'URL publik saat ini:' },
  'The /scooter base stays fixed. Update the last path segment used in every language.': { ru: 'Базовый путь /scooter остаётся фиксированным. Меняйте только последний сегмент пути, общий для всех языков.', id: 'Basis /scooter tetap tetap. Ubah segmen path terakhir yang dipakai di semua bahasa.' },
  'Shared route segment': { ru: 'Общий сегмент маршрута', id: 'Segmen rute bersama' },
  'Path segment': { ru: 'Сегмент пути', id: 'Segmen path' },
  'This language uses the shared scooter URL': { ru: 'Этот язык использует общий URL скутера', id: 'Bahasa ini menggunakan URL skuter bersama' },
  'Scooter title': { ru: 'Название скутера', id: 'Judul skuter' },
  'Ready titles': { ru: 'Готовые названия', id: 'Judul siap' },
  ...
  'Quantity available for booking': { ru: 'Количество для брони', id: 'Jumlah tersedia untuk pemesanan' },
  ...
  'How many identical scooters this card represents. The card stays bookable until all units are taken for the selected dates — no need to create duplicate cards.': { ru: 'Сколько одинаковых скутеров представляет эта карточка. Карточка остаётся доступной для брони, пока не заняты все единицы на выбранные даты — не нужно создавать дубликаты карточек.', id: 'Berapa banyak skuter identik yang diwakili kartu ini. Kartu tetap bisa dipesan sampai semua unit terpakai untuk tanggal yang dipilih — tidak perlu membuat kartu duplikat.' },
  ...
  'Price IDR': { ru: 'Цена IDR', id: 'Harga IDR' },
  'Base price USD': { ru: 'Базовая цена USD', id: 'Harga dasar USD' },
  ...
  'pending_payment': { ru: 'ожидает оплаты', id: 'menunggu pembayaran' },
  ...
  'succeeded': { ru: 'успешно', id: 'berhasil' },
  ...
  'day': { ru: 'день', id: 'hari' },
  'days': { ru: 'дней', id: 'hari' },
  'cash': { ru: 'наличные', id: 'tunai' },
  'card': { ru: 'карта', id: 'kartu' },
  'online': { ru: 'онлайн', id: 'online' },
  'online_card': { ru: 'онлайн картой', id: 'kartu online' },
  'cash_on_delivery': { ru: 'наличными при доставке', id: 'tunai saat pengantaran' },
  'card_on_delivery': { ru: 'картой при доставке', id: 'kartu saat pengantaran' },
  ...
  'Price per day (IDR)': { ru: 'Цена за день (IDR)', id: 'Harga per hari (IDR)' },
  'Price / day (IDR)': { ru: 'Цена / день (IDR)', id: 'Harga / hari (IDR)' },
  'Base price per day (USD)': { ru: 'Базовая цена за день (USD)', id: 'Harga dasar per hari (USD)' },
  'Base price / day (USD)': { ru: 'Базовая цена / день (USD)', id: 'Harga dasar / hari (USD)' },
  'Stored in USD base, preview uses IDR by default.': {
    ru: 'Сохраняется в базовом USD, а превью по умолчанию показывает IDR.',
    id: 'Disimpan dalam basis USD, dan pratinjau secara default memakai IDR.',
  },
